func_call -> fully_qualified_name func_args									{% data => ({ type: "func_call", func: t.first(data), args: t.last(data) }) %}
	| paren_expr func_args 													{% data => ({ type: "func_call", func: t.first(data), args: t.last(data) }) %}
