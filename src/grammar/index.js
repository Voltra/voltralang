...
var grammar = {
    ...
    {"name": "binary_operation", "symbols": ["expr", "__", "binary_operation$string$1", "__", "expr"], "postprocess": t.binaryOp("in")},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "__", {"literal":"="}, "__", "expr"], "postprocess": t.binaryOp("assign")},
    {"name": "binary_operation", "symbols": ["expr", "__nl", {"literal":"+"}, "__", "expr"], "postprocess": t.binaryOp("plus")},
    {"name": "binary_operation", "symbols": ["expr", "__nl", {"literal":"*"}, "__", "expr"], "postprocess": t.binaryOp("times")},
    {"name": "binary_operation", "symbols": ["expr", "__nl", {"literal":"-"}, "__", "expr"], "postprocess": t.binaryOp("minus")},
    {"name": "binary_operation", "symbols": ["expr", "__nl", {"literal":"/"}, "__", "expr"], "postprocess": t.binaryOp("div")},
    {"name": "binary_operation", "symbols": ["expr", "__nl", {"literal":"%"}, "__", "expr"], "postprocess": t.binaryOp("mod")},
    {"name": "binary_operation$string$2", "symbols": [{"literal":"="}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "__nl", "binary_operation$string$2", "__", "expr"], "postprocess": t.binaryOp("eq")},
    {"name": "binary_operation$string$3", "symbols": [{"literal":"!"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "__nl", "binary_operation$string$3", "__", "expr"], "postprocess": t.binaryOp("neq")},
    {"name": "binary_operation", "symbols": ["expr", "__nl", {"literal":"<"}, "__", "expr"], "postprocess": t.binaryOp("lt")},
    {"name": "binary_operation", "symbols": ["expr", "__nl", {"literal":">"}, "__", "expr"], "postprocess": t.binaryOp("gt")},
    {"name": "binary_operation$string$4", "symbols": [{"literal":"<"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "__nl", "binary_operation$string$4", "__", "expr"], "postprocess": t.binaryOp("leq")},
    {"name": "binary_operation$string$5", "symbols": [{"literal":">"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "__nl", "binary_operation$string$5", "__", "expr"], "postprocess": t.binaryOp("geq")},
    {"name": "binary_operation$string$6", "symbols": [{"literal":"&"}, {"literal":"&"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "__nl", "binary_operation$string$6", "__", "expr"], "postprocess": t.binaryOp("land")},
    {"name": "binary_operation$string$7", "symbols": [{"literal":"|"}, {"literal":"|"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "__nl", "binary_operation$string$7", "__", "expr"], "postprocess": t.binaryOp("lor")},
    {"name": "binary_operation", "symbols": ["expr", "__nl", {"literal":"&"}, "__", "expr"], "postprocess": t.binaryOp("bitwise_and")},
    {"name": "binary_operation", "symbols": ["expr", "__nl", {"literal":"|"}, "__", "expr"], "postprocess": t.binaryOp("bitwise_or")},
    {"name": "binary_operation", "symbols": ["expr", "__nl", {"literal":"^"}, "__", "expr"], "postprocess": t.binaryOp("bitwise_xor")},
    {"name": "binary_operation$string$8", "symbols": [{"literal":"?"}, {"literal":"?"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "__nl", "binary_operation$string$8", "__", "expr"], "postprocess": t.binaryOp("null_coalescing")},
    {"name": "binary_operation$string$9", "symbols": [{"literal":"+"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "__nl", "binary_operation$string$9", "__", "expr"], "postprocess": t.binaryOp("plus_eq")},
    {"name": "binary_operation$string$10", "symbols": [{"literal":"-"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "__nl", "binary_operation$string$10", "__", "expr"], "postprocess": t.binaryOp("minus_eq")},
    {"name": "binary_operation$string$11", "symbols": [{"literal":"*"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "__nl", "binary_operation$string$11", "__", "expr"], "postprocess": t.binaryOp("times_eq")},
    {"name": "binary_operation$string$12", "symbols": [{"literal":"/"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "__nl", "binary_operation$string$12", "__", "expr"], "postprocess": t.binaryOp("div_eq")},
    {"name": "binary_operation$string$13", "symbols": [{"literal":"%"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "__nl", "binary_operation$string$13", "__", "expr"], "postprocess": t.binaryOp("mod_eq")},
    {"name": "binary_operation$string$14", "symbols": [{"literal":"&"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "__nl", "binary_operation$string$14", "__", "expr"], "postprocess": t.binaryOp("bitwise_and_eq")},
    {"name": "binary_operation$string$15", "symbols": [{"literal":"|"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "__nl", "binary_operation$string$15", "__", "expr"], "postprocess": t.binaryOp("bitwise_or_eq")},
    {"name": "binary_operation$string$16", "symbols": [{"literal":"^"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "__nl", "binary_operation$string$16", "__", "expr"], "postprocess": t.binaryOp("bitwise_xor_eq")},
    {"name": "binary_operation$string$17", "symbols": [{"literal":"~"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "__nl", "binary_operation$string$17", "__", "expr"], "postprocess": t.binaryOp("bitwise_neg_eq")},
    {"name": "binary_operation$string$18", "symbols": [{"literal":"&"}, {"literal":"&"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "__nl", "binary_operation$string$18", "__", "expr"], "postprocess": t.binaryOp("land_eq")},
    {"name": "binary_operation$string$19", "symbols": [{"literal":"|"}, {"literal":"|"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "__nl", "binary_operation$string$19", "__", "expr"], "postprocess": t.binaryOp("lor_eq")},
    {"name": "binary_operation$string$20", "symbols": [{"literal":"*"}, {"literal":"*"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "__nl", "binary_operation$string$20", "__", "expr"], "postprocess": t.binaryOp("pow")},
    ...
    {"name": "params$ebnf$1$subexpression$1", "symbols": ["_nl", "param_list", "_nl"]},
    ...
    {"name": "params", "symbols": [{"literal":"("}, "params$ebnf$1", {"literal":")"}], "postprocess": t.mid},
    ...
    {"name": "matchBody", "symbols": [{"literal":"{"}, "__nl", "matchBody$ebnf$1", "__nl", "matchDefaultBranch", "__nl", {"literal":"}"}], "postprocess": data => ({ type: "match_body", branches: t.beforeMid(data), defaultBranch: t.afterMid(data) })},
    ...
    {"name": "matchOrIntroduceVariable", "symbols": ["ident"], "postprocess": data => ({ type: "introduce_variable_match", structure: t.first(data) })},
    {"name": "program$ebnf$1", "symbols": ["_nl"], "postprocess": id},
    {"name": "program$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "program$ebnf$2", "symbols": []},
    {"name": "program$ebnf$2$subexpression$1", "symbols": ["expr", "_nl"]},
    ...
    {"name": "program", "symbols": ["program$ebnf$1", "program$ebnf$2"], "postprocess": t.mapSecond(t.first)},
    ...
    {"name": "fully_qualified_name$ebnf$1$subexpression$2", "symbols": ["ident", {"literal":"::"}]},
    ...
    {"name": "fully_qualified_name", "symbols": ["fully_qualified_name$ebnf$1", "fully_qualified_name$subexpression$1"], "postprocess": data => ({ type: "fqn", path: [...t.first(data).map(id), t.last(data)] })},
    ...
    {"name": "expr_block", "symbols": [{"literal":"{"}, "_nl", "expr_block$ebnf$1", "_nl", {"literal":"}"}], "postprocess": data => ({ type: "expr_block", exprs: t.mid(data) })},
    ...
    {"name": "ternary", "symbols": ["expr", "_nl", {"literal":"?"}, "_", "expr", "_nl", {"literal":":"}, "_", "expr"], "postprocess": data => ({ type: "ternary", condition: t.first(data), ifTrue: t.mid(data), ifFalse: t.last(data) })}
]
  , ParserStart: "program"
}
