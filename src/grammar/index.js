...
var grammar = {
    ...
    {"name": "arg_list$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "__nl", "value_expr"]},
    ...
    {"name": "ufc", "symbols": ["value_expr", {"literal":"@"}, "func_call"], "postprocess": data => ({ type: "ufc", caller: t.first(data), call: t.last(data) })},
    {"name": "method_call", "symbols": ["value_expr", {"literal":"."}, "ident", "func_args"], "postprocess": data => ({ type: "method_call", object: t.first(data), method: t.beforeLast(data), args: t.last(data) })},
    {"name": "method_call", "symbols": ["value_expr", {"literal":"["}, "_nl", "value_expr", "_nl", {"literal":"]"}, "func_args"], "postprocess": data => ({ type: "method_call", object: t.first(data), method: data[3], args: t.last(data) })},
    ...
    {"name": "operation", "symbols": ["func_call"], "postprocess": id},
    {"name": "operation", "symbols": ["ufc"], "postprocess": id},
    {"name": "operation", "symbols": ["method_call"], "postprocess": id},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", {"literal":"="}, "__", "value_expr"], "postprocess": t.binaryOp("assign")},
    {"name": "assign_expr$string$1", "symbols": [{"literal":"+"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", "assign_expr$string$1", "__", "value_expr"], "postprocess": t.binaryOp("plus_eq")},
    {"name": "assign_expr$string$2", "symbols": [{"literal":"-"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", "assign_expr$string$2", "__", "value_expr"], "postprocess": t.binaryOp("minus_eq")},
    {"name": "assign_expr$string$3", "symbols": [{"literal":"*"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", "assign_expr$string$3", "__", "value_expr"], "postprocess": t.binaryOp("times_eq")},
    {"name": "assign_expr$string$4", "symbols": [{"literal":"/"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", "assign_expr$string$4", "__", "value_expr"], "postprocess": t.binaryOp("div_eq")},
    {"name": "assign_expr$string$5", "symbols": [{"literal":"%"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", "assign_expr$string$5", "__", "value_expr"], "postprocess": t.binaryOp("mod_eq")},
    {"name": "assign_expr$string$6", "symbols": [{"literal":"&"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", "assign_expr$string$6", "__", "value_expr"], "postprocess": t.binaryOp("bitwise_and_eq")},
    {"name": "assign_expr$string$7", "symbols": [{"literal":"|"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", "assign_expr$string$7", "__", "value_expr"], "postprocess": t.binaryOp("bitwise_or_eq")},
    {"name": "assign_expr$string$8", "symbols": [{"literal":"^"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", "assign_expr$string$8", "__", "value_expr"], "postprocess": t.binaryOp("bitwise_xor_eq")},
    {"name": "assign_expr$string$9", "symbols": [{"literal":"~"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", "assign_expr$string$9", "__", "value_expr"], "postprocess": t.binaryOp("bitwise_neg_eq")},
    {"name": "assign_expr$string$10", "symbols": [{"literal":"&"}, {"literal":"&"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", "assign_expr$string$10", "__", "value_expr"], "postprocess": t.binaryOp("land_eq")},
    {"name": "assign_expr$string$11", "symbols": [{"literal":"|"}, {"literal":"|"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", "assign_expr$string$11", "__", "value_expr"], "postprocess": t.binaryOp("lor_eq")},
    {"name": "assign_expr$string$12", "symbols": [{"literal":"!"}, {"literal":"!"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "assign_expr", "symbols": ["_", "assign_expr$string$12", "fully_qualified_name"], "postprocess": t.unaryOp("unary_neg_eq")},
    ...
    {"name": "pow_expr", "symbols": [{"literal":"-"}, "value_expr"], "postprocess": t.unaryOp("unary_minus")},
    {"name": "pow_expr", "symbols": [{"literal":"+"}, "value_expr"], "postprocess": t.unaryOp("unary_plus")},
    ...
    {"name": "bit_expr", "symbols": [{"literal":"~"}, "value_expr"], "postprocess": t.unaryOp("bitwise_neg")},
    ...
    {"name": "logical_expr", "symbols": ["logical_expr", "__nl", "logical_expr$string$1", "__", "value_expr"], "postprocess": t.binaryOp("land")},
    {"name": "logical_expr$string$2", "symbols": [{"literal":"|"}, {"literal":"|"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "logical_expr", "symbols": ["logical_expr", "__nl", "logical_expr$string$2", "__", "value_expr"], "postprocess": t.binaryOp("lor")},
    {"name": "logical_expr$string$3", "symbols": [{"literal":"="}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "logical_expr", "symbols": ["logical_expr", "__nl", "logical_expr$string$3", "__", "value_expr"], "postprocess": t.binaryOp("eq")},
    {"name": "logical_expr$string$4", "symbols": [{"literal":"!"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "logical_expr", "symbols": ["logical_expr", "__nl", "logical_expr$string$4", "__", "value_expr"], "postprocess": t.binaryOp("neq")},
    {"name": "logical_expr", "symbols": ["logical_expr", "__nl", {"literal":"<"}, "__", "value_expr"], "postprocess": t.binaryOp("lt")},
    {"name": "logical_expr", "symbols": ["logical_expr", "__nl", {"literal":">"}, "__", "value_expr"], "postprocess": t.binaryOp("gt")},
    {"name": "logical_expr$string$5", "symbols": [{"literal":"<"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "logical_expr", "symbols": ["logical_expr", "__nl", "logical_expr$string$5", "__", "value_expr"], "postprocess": t.binaryOp("leq")},
    {"name": "logical_expr$string$6", "symbols": [{"literal":">"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "logical_expr", "symbols": ["logical_expr", "__nl", "logical_expr$string$6", "__", "value_expr"], "postprocess": t.binaryOp("geq")},
    {"name": "logical_expr", "symbols": [{"literal":"!"}, "value_expr"], "postprocess": t.unaryOp("neg")},
    {"name": "spe_expr$string$1", "symbols": [{"literal":"i"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "spe_expr", "symbols": ["value_expr", "__nl", "spe_expr$string$1", "__", "value_expr"], "postprocess": t.binaryOp("in")},
    {"name": "spe_expr$string$2", "symbols": [{"literal":"?"}, {"literal":"?"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "spe_expr", "symbols": ["value_expr", "__nl", "spe_expr$string$2", "__", "value_expr"], "postprocess": t.binaryOp("null_coalescing")},
    {"name": "spe_expr", "symbols": ["value_expr", "__nl", {"literal":"?"}, "__", "value_expr", "__nl", {"literal":":"}, "__", "value_expr"], "postprocess": data => ({ type: "ternary", condition: t.first(data), ifTrue: t.mid(data), ifFalse: t.last(data) })},
    ...
    {"name": "throw_stmt", "symbols": ["throw_stmt$string$1", "__", "value_expr"], "postprocess": data => ({ type: "throw_stmt", exception: t.last(data) })},
    ...
    {"name": "whileBlock", "symbols": ["whileBlock$string$1", "_", {"literal":"("}, "_nl", "value_expr", "_nl", {"literal":")"}], "postprocess": t.afterMid},
    ...
    {"name": "nullLiteral", "symbols": ["nullLiteral$string$1"], "postprocess": id},
    ...
    {"name": "match_expr", "symbols": ["match_expr$string$1", {"literal":"("}, "_nl", "value_expr", "_nl", {"literal":")"}, "matchBody"], "postprocess": data => ({ type: "match_stmt", matched: t.mid(data), body: t.last(data) })},
    ...
    {"name": "matchBranchBody", "symbols": ["__", "matchBranchBody$string$1", "__", "value_expr"], "postprocess": t.last},
    ...
    {"name": "expr", "symbols": ["value_expr"], "postprocess": id},
    {"name": "expr", "symbols": ["no_value_expr"], "postprocess": id},
    {"name": "value_expr", "symbols": ["literal"], "postprocess": id},
    {"name": "value_expr", "symbols": ["fully_qualified_name"], "postprocess": id},
    {"name": "value_expr", "symbols": ["paren_expr"], "postprocess": id},
    {"name": "value_expr", "symbols": ["operation"], "postprocess": id},
    {"name": "value_expr", "symbols": ["match_expr"], "postprocess": id},
    ...
    {"name": "paren_expr", "symbols": [{"literal":"("}, "_nl", "value_expr", "_nl", {"literal":")"}], "postprocess": data => ({ type: "paren_expr", expr: t.mid(data) })},
