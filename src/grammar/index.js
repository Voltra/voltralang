...
var grammar = {
    ...
    {"name": "operation", "symbols": ["_numeric_operation"], "postprocess": id},
    {"name": "operation", "symbols": ["_logical_operation"], "postprocess": id},
    {"name": "operation", "symbols": ["spe_expr"], "postprocess": id},
    {"name": "_numeric_operation", "symbols": ["sum_expr"], "postprocess": id},
    {"name": "_numeric_operation", "symbols": ["mult_expr"], "postprocess": id},
    {"name": "_numeric_operation", "symbols": ["pow_expr"], "postprocess": id},
    {"name": "_numeric_operation", "symbols": ["bit_expr"], "postprocess": id},
    {"name": "_numeric_operation", "symbols": ["unary_expr"], "postprocess": id},
    {"name": "_logical_operation", "symbols": ["disjonction"], "postprocess": id},
    {"name": "_logical_operation", "symbols": ["conjonction"], "postprocess": id},
    {"name": "_logical_operation", "symbols": ["logical_unary"], "postprocess": id},
