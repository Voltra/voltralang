...
var grammar = {
    ...
    {"name": "unary_operation", "symbols": ["fully_qualified_name", "unary_operation$string$3"], "postprocess": t.unaryOpPost("post_increment")},
    ...
    {"name": "unary_operation", "symbols": ["fully_qualified_name", "unary_operation$string$5"], "postprocess": t.unaryOpPost("post_decrement")},
    ...
    {"name": "program$ebnf$1$subexpression$1", "symbols": ["expr", "_nl"]},
    {"name": "program$ebnf$1", "symbols": ["program$ebnf$1$subexpression$1"]},
    {"name": "program$ebnf$1$subexpression$2", "symbols": ["expr", "_nl"]},
    ...
    {"name": "program", "symbols": ["_nl", "program$ebnf$1"], "postprocess": t.mapSecond(t.first)},
    ...
    {"name": "expr_block", "symbols": [{"literal":"{"}, "__nl", "expr_block$ebnf$1", "__nl", {"literal":"}"}], "postprocess": data => ({ type: "expr_block", exprs: t.mid(data) })},
