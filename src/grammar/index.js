...
var grammar = {
    ...
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", assign, "__", "operation"], "postprocess": t.binaryOp("assign")},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", plus_eq, "__", "operation"], "postprocess": t.binaryOp("plus_eq")},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", minus_eq, "__", "operation"], "postprocess": t.binaryOp("minus_eq")},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", times_eq, "__", "operation"], "postprocess": t.binaryOp("times_eq")},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", div_eq, "__", "operation"], "postprocess": t.binaryOp("div_eq")},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", mod_eq, "__", "operation"], "postprocess": t.binaryOp("mod_eq")},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", bitwise_and_eq, "__", "operation"], "postprocess": t.binaryOp("bitwise_and_eq")},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", bitwise_or_eq, "__", "operation"], "postprocess": t.binaryOp("bitwise_or_eq")},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", bitwise_xor_eq, "__", "operation"], "postprocess": t.binaryOp("bitwise_xor_eq")},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", land_eq, "__", "operation"], "postprocess": t.binaryOp("land_eq")},
    {"name": "assign_expr", "symbols": ["fully_qualified_name", "__nl", lor_eq, "__", "operation"], "postprocess": t.binaryOp("lor_eq")},
    {"name": "assign_expr", "symbols": [unary_neg_eq, "fully_qualified_name"], "postprocess": t.unaryOp("unary_neg_eq")},
    {"name": "sum_expr", "symbols": ["sum_expr", "__nl", plus, "__", "sum_expr"], "postprocess": t.binaryOp("plus")},
    {"name": "sum_expr", "symbols": ["sum_expr", "__nl", minus, "__", "sum_expr"], "postprocess": t.binaryOp("minus")},
    {"name": "sum_expr", "symbols": ["mult_expr"], "postprocess": id},
    {"name": "mult_expr", "symbols": ["mult_expr", "__nl", times, "__", "mult_expr"], "postprocess": t.binaryOp("times")},
    {"name": "mult_expr", "symbols": ["mult_expr", "__nl", div, "__", "mult_expr"], "postprocess": t.binaryOp("div")},
    {"name": "mult_expr", "symbols": ["mult_expr", "__nl", mod, "__", "mult_expr"], "postprocess": t.binaryOp("mod")},
    {"name": "mult_expr", "symbols": ["pow_expr"], "postprocess": id},
    {"name": "pow_expr", "symbols": ["pow_expr", "__nl", pow, "__", "bit_expr"], "postprocess": t.binaryOp("pow")},
    {"name": "pow_expr", "symbols": [minus, "value_expr"], "postprocess": t.unaryOp("unary_minus")},
    {"name": "pow_expr", "symbols": [plus, "value_expr"], "postprocess": t.unaryOp("unary_plus")},
    {"name": "pow_expr", "symbols": ["bit_expr"], "postprocess": id},
    {"name": "bit_expr", "symbols": ["bit_expr", "__nl", bitwise_and, "__", "bit_expr"], "postprocess": t.binaryOp("bitwise_and")},
    {"name": "bit_expr", "symbols": ["bit_expr", "__nl", bitwise_or, "__", "bit_expr"], "postprocess": t.binaryOp("bitwise_or")},
    {"name": "bit_expr", "symbols": ["bit_expr", "__nl", bitwise_xor, "__", "bit_expr"], "postprocess": t.binaryOp("bitwise_xor")},
    {"name": "bit_expr", "symbols": [bitwise_neg, "value_expr"], "postprocess": t.unaryOp("bitwise_neg")},
    ...
    {"name": "unary_expr", "symbols": ["simple_value"], "postprocess": id},
    {"name": "logical_expr", "symbols": ["disjonction"], "postprocess": id},
    {"name": "disjonction", "symbols": ["conjonction", "__nl", lor, "__", "conjonction"], "postprocess": t.binaryOp("lor")},
    {"name": "disjonction", "symbols": ["conjonction"], "postprocess": id},
    {"name": "conjonction", "symbols": ["logical_unary", "__nl", land, "__", "logical_unary"], "postprocess": t.binaryOp("land")},
    {"name": "conjonction", "symbols": ["logical_unary"]},
    {"name": "logical_unary", "symbols": [neg, "value_expr"], "postprocess": t.unaryOp("neg")},
    {"name": "logical_unary", "symbols": ["value_expr", "__nl", kWin, "__", "value_expr"], "postprocess": t.binaryOp("in")},
    {"name": "logical_unary", "symbols": ["logical_unary", "__nl", eq, "__", "logical_unary"], "postprocess": t.binaryOp("eq")},
    {"name": "logical_unary", "symbols": ["logical_unary", "__nl", neq, "__", "logical_unary"], "postprocess": t.binaryOp("neq")},
    {"name": "logical_unary", "symbols": ["logical_unary", "__nl", lt, "__", "logical_unary"], "postprocess": t.binaryOp("lt")},
    {"name": "logical_unary", "symbols": ["logical_unary", "__nl", gt, "__", "logical_unary"], "postprocess": t.binaryOp("gt")},
    {"name": "logical_unary", "symbols": ["logical_unary", "__nl", leq, "__", "logical_unary"], "postprocess": t.binaryOp("leq")},
    {"name": "logical_unary", "symbols": ["logical_unary", "__nl", geq, "__", "logical_unary"], "postprocess": t.binaryOp("geq")},
    {"name": "logical_unary", "symbols": ["simple_value"], "postprocess": id},
    ...
    {"name": "simple_value", "symbols": ["literal"], "postprocess": id},
    {"name": "simple_value", "symbols": ["fully_qualified_name"], "postprocess": id},
    {"name": "simple_value", "symbols": ["paren_expr"], "postprocess": id},
    {"name": "simple_value", "symbols": ["expr_statement"], "postprocess": id},
    ...
    {"name": "statement", "symbols": ["expr", "_", semi], "postprocess": t.first},
    ...
    {"name": "expr_block$ebnf$1$subexpression$1$ebnf$1", "symbols": [semi], "postprocess": id},
    {"name": "expr_block$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "expr_block$ebnf$1$subexpression$1", "symbols": ["expr", "expr_block$ebnf$1$subexpression$1$ebnf$1", "__nl"]},
