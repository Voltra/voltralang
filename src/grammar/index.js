...
var grammar = {
    ...
    {"name": "pow_expr", "symbols": [minus, "name_or_literal"], "postprocess": t.unaryOp("unary_minus")},
    {"name": "pow_expr", "symbols": [plus, "name_or_literal"], "postprocess": t.unaryOp("unary_plus")},
    ...
    {"name": "simple_value", "symbols": ["name_or_literal"], "postprocess": id},
    {"name": "simple_value", "symbols": ["paren_expr"], "postprocess": id},
    {"name": "name_or_literal", "symbols": ["literal"], "postprocess": id},
    {"name": "name_or_literal", "symbols": ["fully_qualified_name"], "postprocess": id},
    {"name": "name_or_literal", "symbols": ["func_call"], "postprocess": id},
    {"name": "name_or_literal", "symbols": ["ufc"], "postprocess": id},
    {"name": "name_or_literal", "symbols": ["method_call"], "postprocess": id},
