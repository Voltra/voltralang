...
var grammar = {
    ...
    {"name": "wschar", "symbols": [/[ \t\n\v\f]/], "postprocess": id},
    {"name": "unary_operation", "symbols": [{"literal":"!"}, "expr"], "postprocess": t.unaryOp("neg")},
    {"name": "unary_operation", "symbols": [{"literal":"+"}, "expr"], "postprocess": t.unaryOp("unary_plus")},
    {"name": "unary_operation", "symbols": [{"literal":"-"}, "expr"], "postprocess": t.unaryOp("unary_minus")},
    {"name": "unary_operation", "symbols": [{"literal":"~"}, "expr"], "postprocess": t.unaryOp("bitwise_neg")},
    {"name": "unary_operation$string$1", "symbols": [{"literal":"!"}, {"literal":"!"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unary_operation", "symbols": ["unary_operation$string$1", "fully_qualified_name"], "postprocess": t.unaryOp("unary_neg_eq")},
    {"name": "unary_operation$string$2", "symbols": [{"literal":"+"}, {"literal":"+"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unary_operation", "symbols": ["unary_operation$string$2", "fully_qualified_name"], "postprocess": t.unaryOp("pre_increment")},
    {"name": "unary_operation$string$3", "symbols": [{"literal":"+"}, {"literal":"+"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unary_operation", "symbols": ["fully_qualified_name", "unary_operation$string$3"], "postprocess": t.unaryOp("post_increment")},
    {"name": "unary_operation$string$4", "symbols": [{"literal":"-"}, {"literal":"-"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unary_operation", "symbols": ["unary_operation$string$4", "fully_qualified_name"], "postprocess": t.unaryOp("pre_decrement")},
    {"name": "unary_operation$string$5", "symbols": [{"literal":"-"}, {"literal":"-"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unary_operation", "symbols": ["fully_qualified_name", "unary_operation$string$5"], "postprocess": t.unaryOp("post_decrement")},
    {"name": "binary_operation$string$1", "symbols": [{"literal":"i"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "_", "binary_operation$string$1", "_", "expr"], "postprocess": t.binaryOp("in")},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "_", {"literal":"="}, "_", "expr"], "postprocess": t.binaryOp("assign")},
    {"name": "binary_operation", "symbols": ["expr", "_", {"literal":"+"}, "_", "expr"], "postprocess": t.binaryOp("plus")},
    {"name": "binary_operation", "symbols": ["expr", "_", {"literal":"*"}, "_", "expr"], "postprocess": t.binaryOp("times")},
    {"name": "binary_operation", "symbols": ["expr", "_", {"literal":"-"}, "_", "expr"], "postprocess": t.binaryOp("minus")},
    {"name": "binary_operation", "symbols": ["expr", "_", {"literal":"/"}, "_", "expr"], "postprocess": t.binaryOp("div")},
    {"name": "binary_operation", "symbols": ["expr", "_", {"literal":"%"}, "_", "expr"], "postprocess": t.binaryOp("mod")},
    {"name": "binary_operation$string$2", "symbols": [{"literal":"="}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "_", "binary_operation$string$2", "_", "expr"], "postprocess": t.binaryOp("eq")},
    {"name": "binary_operation$string$3", "symbols": [{"literal":"!"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "_", "binary_operation$string$3", "_", "expr"], "postprocess": t.binaryOp("neq")},
    {"name": "binary_operation", "symbols": ["expr", "_", {"literal":"<"}, "_", "expr"], "postprocess": t.binaryOp("lt")},
    {"name": "binary_operation", "symbols": ["expr", "_", {"literal":">"}, "_", "expr"], "postprocess": t.binaryOp("gt")},
    {"name": "binary_operation$string$4", "symbols": [{"literal":"<"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "_", "binary_operation$string$4", "_", "expr"], "postprocess": t.binaryOp("leq")},
    {"name": "binary_operation$string$5", "symbols": [{"literal":">"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "_", "binary_operation$string$5", "_", "expr"], "postprocess": t.binaryOp("geq")},
    {"name": "binary_operation$string$6", "symbols": [{"literal":"&"}, {"literal":"&"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "_", "binary_operation$string$6", "_", "expr"], "postprocess": t.binaryOp("land")},
    {"name": "binary_operation$string$7", "symbols": [{"literal":"|"}, {"literal":"|"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "_", "binary_operation$string$7", "_", "expr"], "postprocess": t.binaryOp("lor")},
    {"name": "binary_operation", "symbols": ["expr", "_", {"literal":"&"}, "_", "expr"], "postprocess": t.binaryOp("bitwise_and")},
    {"name": "binary_operation", "symbols": ["expr", "_", {"literal":"|"}, "_", "expr"], "postprocess": t.binaryOp("bitwise_or")},
    {"name": "binary_operation", "symbols": ["expr", "_", {"literal":"^"}, "_", "expr"], "postprocess": t.binaryOp("bitwise_xor")},
    {"name": "binary_operation$string$8", "symbols": [{"literal":"?"}, {"literal":"?"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "_", "binary_operation$string$8", "_", "expr"], "postprocess": t.binaryOp("null_coalescing")},
    {"name": "binary_operation$string$9", "symbols": [{"literal":"+"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "_", "binary_operation$string$9", "_", "expr"], "postprocess": t.binaryOp("plus_eq")},
    {"name": "binary_operation$string$10", "symbols": [{"literal":"-"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "_", "binary_operation$string$10", "_", "expr"], "postprocess": t.binaryOp("minus_eq")},
    {"name": "binary_operation$string$11", "symbols": [{"literal":"*"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "_", "binary_operation$string$11", "_", "expr"], "postprocess": t.binaryOp("times_eq")},
    {"name": "binary_operation$string$12", "symbols": [{"literal":"/"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "_", "binary_operation$string$12", "_", "expr"], "postprocess": t.binaryOp("div_eq")},
    {"name": "binary_operation$string$13", "symbols": [{"literal":"%"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "_", "binary_operation$string$13", "_", "expr"], "postprocess": t.binaryOp("mod_eq")},
    {"name": "binary_operation$string$14", "symbols": [{"literal":"&"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "_", "binary_operation$string$14", "_", "expr"], "postprocess": t.binaryOp("bitwise_and_eq")},
    {"name": "binary_operation$string$15", "symbols": [{"literal":"|"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "_", "binary_operation$string$15", "_", "expr"], "postprocess": t.binaryOp("bitwise_or_eq")},
    {"name": "binary_operation$string$16", "symbols": [{"literal":"^"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "_", "binary_operation$string$16", "_", "expr"], "postprocess": t.binaryOp("bitwise_xor_eq")},
    {"name": "binary_operation$string$17", "symbols": [{"literal":"~"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "_", "binary_operation$string$17", "_", "expr"], "postprocess": t.binaryOp("bitwise_neg_eq")},
    {"name": "binary_operation$string$18", "symbols": [{"literal":"&"}, {"literal":"&"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "_", "binary_operation$string$18", "_", "expr"], "postprocess": t.binaryOp("land_eq")},
    {"name": "binary_operation$string$19", "symbols": [{"literal":"|"}, {"literal":"|"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["fully_qualified_name", "_", "binary_operation$string$19", "_", "expr"], "postprocess": t.binaryOp("lor_eq")},
    {"name": "binary_operation$string$20", "symbols": [{"literal":"*"}, {"literal":"*"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binary_operation", "symbols": ["expr", "_", "binary_operation$string$20", "_", "expr"], "postprocess": t.binaryOp("pow")},
    {"name": "operation", "symbols": ["unary_operation"], "postprocess": id},
    ...
    {"name": "arg_list$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "expr"]},
    ...
    {"name": "arg_list$ebnf$2$subexpression$1", "symbols": ["_", {"literal":","}, "_"]},
    ...
    {"name": "method_call", "symbols": ["expr", {"literal":"["}, "_", "expr", "_", {"literal":"]"}, "func_args"], "postprocess": data => ({ type: "method_call", object: t.first(data), method: data[3], args: t.last(data) })},
    {"name": "params", "symbols": [{"literal":"("}, "_", "param_list", "_", {"literal":")"}], "postprocess": t.mid},
    ...
    {"name": "throw_stmt", "symbols": ["throw_stmt$string$1", "_", "expr"], "postprocess": data => ({ type: "throw_stmt", exception: t.last(data) })},
    {"name": "ifBranch$string$1", "symbols": [{"literal":"i"}, {"literal":"f"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ifBranch", "symbols": ["ifBranch$string$1", "_", {"literal":"("}, "_", "expr", "_", {"literal":")"}, "_", "expr"], "postprocess": data => ({ type: "if_branch", condition:t.mid(data), body: t.last(data) })},
    {"name": "elseIfBranch$string$1", "symbols": [{"literal":"e"}, {"literal":"l"}, {"literal":"s"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "elseIfBranch", "symbols": ["elseIfBranch$string$1", "_", "ifBranch"], "postprocess": data => ({ ...t.last(data), type: "else_if_branch" })},
    {"name": "elseBranch$string$1", "symbols": [{"literal":"e"}, {"literal":"l"}, {"literal":"s"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "elseBranch", "symbols": ["elseBranch$string$1", "_", "expr"], "postprocess": data => ({ ...t.last(data), type: "else_branch" })},
    ...
    {"name": "whileBlock", "symbols": ["whileBlock$string$1", "_", {"literal":"("}, "_", "expr", "_", {"literal":")"}], "postprocess": t.afterMid},
    ...
    {"name": "while_stmt", "symbols": ["whileBlock", "_", "expr"], "postprocess": data => ({ type: "while_stmt", condition: t.first(data), body: t.last(data) })},
    {"name": "do_while_stmt$string$1", "symbols": [{"literal":"d"}, {"literal":"o"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "do_while_stmt", "symbols": ["do_while_stmt$string$1", "_", "expr", "_", "whileBlock"], "postprocess": data => ({ type: "do_while_stmt", condition: t.last(data), body: t.mid(data) })},
    {"name": "arrayLiteral", "symbols": [{"literal":"["}, "_", "arg_list", "_", {"literal":"]"}], "postprocess": data => ({ type: "arrayLiteral", items: t.mid(data) })},
    {"name": "objectLiteral", "symbols": [{"literal":"{"}, "_", {"literal":"}"}], "postprocess": data => ({ type: "objectLiteral", entries: t.mid(data) })},
    ...
    {"name": "destructuring_list$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "ident", "_"]},
    ...
    {"name": "destructuring_list$ebnf$2$subexpression$1", "symbols": [{"literal":","}, "_"]},
    ...
    {"name": "match_expr", "symbols": ["match_expr$string$1", {"literal":"("}, "_", "expr", "_", {"literal":")"}, "matchBody"], "postprocess": data => ({ type: "match_stmt", matched: t.mid(data), body: t.last(data) })},
    ...
    {"name": "matchBody", "symbols": [{"literal":"{"}, "_", "matchBody$ebnf$1", "_", "matchDefaultBranch", "_", {"literal":"}"}], "postprocess": data => ({ type: "match_body", branches: t.beforeMid(data), defaultBranch: t.afterMid(data) })},
    ...
    {"name": "matchBranchBody", "symbols": ["_", "matchBranchBody$string$1", "_", "expr"], "postprocess": t.last},
    {"name": "matchBranch", "symbols": ["matchStructure", "matchBranchBody"], "postprocess": data => ({ type: "match_branch", body: t.last(data), structure: matchStructure })},
    ...
    {"name": "matchStructure$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "matchStructure"]},
    {"name": "matchStructure$ebnf$1", "symbols": ["matchStructure$ebnf$1$subexpression$1"]},
    {"name": "matchStructure$ebnf$1$subexpression$2", "symbols": ["_", {"literal":","}, "_", "matchStructure"]},
    ...
    {"name": "matchStructure$ebnf$2$subexpression$1", "symbols": ["_", {"literal":","}, "_"]},
    ...
    {"name": "matchStructure$ebnf$3$subexpression$1", "symbols": ["_", {"literal":"&"}, "_", "matchStructure"]},
    {"name": "matchStructure$ebnf$3", "symbols": ["matchStructure$ebnf$3$subexpression$1"]},
    {"name": "matchStructure$ebnf$3$subexpression$2", "symbols": ["_", {"literal":"&"}, "_", "matchStructure"]},
    ...
    {"name": "matchStructure$ebnf$4$subexpression$1", "symbols": ["_", {"literal":"&"}, "_"]},
    ...
    {"name": "matchStructure", "symbols": [{"literal":"["}, "_", "matchOrIntroduceVariable", "_", {"literal":"|"}, "_", "matchOrIntroduceVariable", "_", {"literal":"]"}], "postprocess": data => ({ type: "array_match", head: data[2], tail: data[6] })},
    {"name": "matchVariable", "symbols": [{"literal":"<"}, "_", "fully_qualified_name", "_", {"literal":">"}], "postprocess": data => ({ type: "variable_match", structure: t.mid(data) })},
    {"name": "matchIntroduceVariable", "symbols": ["ident"], "postprocess": data => ({ type: "introduce_variable_match", structure: t.first(data) })},
    {"name": "matchOrIntroduceVariable", "symbols": ["matchVariable"], "postprocess": id},
    {"name": "matchOrIntroduceVariable", "symbols": ["matchIntroduceVariable"], "postprocess": id},
    {"name": "program$ebnf$1$subexpression$1$ebnf$1", "symbols": ["_"], "postprocess": id},
    {"name": "program$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "program$ebnf$1$subexpression$1$ebnf$2", "symbols": ["_"], "postprocess": id},
    {"name": "program$ebnf$1$subexpression$1$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "program$ebnf$1$subexpression$1", "symbols": ["program$ebnf$1$subexpression$1$ebnf$1", "expr", "program$ebnf$1$subexpression$1$ebnf$2"]},
    {"name": "program$ebnf$1", "symbols": ["program$ebnf$1$subexpression$1"]},
    {"name": "program$ebnf$1$subexpression$2$ebnf$1", "symbols": ["_"], "postprocess": id},
    {"name": "program$ebnf$1$subexpression$2$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "program$ebnf$1$subexpression$2$ebnf$2", "symbols": ["_"], "postprocess": id},
    {"name": "program$ebnf$1$subexpression$2$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "program$ebnf$1$subexpression$2", "symbols": ["program$ebnf$1$subexpression$2$ebnf$1", "expr", "program$ebnf$1$subexpression$2$ebnf$2"]},
    ...
    {"name": "program", "symbols": ["program$ebnf$1"], "postprocess": t.mapFirst(t.mid)},
    ...
    {"name": "literal", "symbols": ["booleanLiteral"]},
    ...
    {"name": "operator_name", "symbols": [{"literal":"operator"}, "operator"], "postprocess": data => ({ type: "operator_name", operator: t.last(data) })},
    {"name": "fully_qualified_name", "symbols": ["ident"], "postprocess": id},
    {"name": "fully_qualified_name$ebnf$1$subexpression$1", "symbols": ["ident", {"literal":"::"}], "postprocess": id},
    {"name": "fully_qualified_name$ebnf$1", "symbols": ["fully_qualified_name$ebnf$1$subexpression$1"]},
    {"name": "fully_qualified_name$ebnf$1$subexpression$2", "symbols": ["ident", {"literal":"::"}], "postprocess": id},
    {"name": "fully_qualified_name$ebnf$1", "symbols": ["fully_qualified_name$ebnf$1", "fully_qualified_name$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "fully_qualified_name", "symbols": ["fully_qualified_name$ebnf$1", "fully_qualified_name$subexpression$1"], "postprocess": data => ({ type: "fqn", path: [...t.first(data), t.last(data)] })},
    ...
    {"name": "paren_expr", "symbols": [{"literal":"("}, "_", "expr", "_", {"literal":")"}], "postprocess": data => ({ type: "paren_expr", expr: t.mid(data) })},
    {"name": "expr_block$ebnf$1", "symbols": ["expr"]},
    {"name": "expr_block$ebnf$1", "symbols": ["expr_block$ebnf$1", "expr"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "expr_block", "symbols": [{"literal":"{"}, "_", "expr_block$ebnf$1", "_", {"literal":"}"}], "postprocess": data => ({ type: "expr_block", exprs: t.mid(data) })},
    {"name": "expression_body", "symbols": ["_", {"literal":"=>"}, "_", "expr"], "postprocess": data => ({ type: "expression_body", body: t.last(data) })},
    {"name": "computed_body", "symbols": ["_", {"literal":"~>"}, "_", "expr"], "postprocess": data => ({ type: "computed_body", body: t.last(data) })},
    {"name": "ternary", "symbols": ["expr", "_", {"literal":"?"}, "_", "expr", "_", {"literal":":"}, "_", "expr"], "postprocess": data => ({ type: "ternary", condition: t.first(data), ifTrue: t.mid(data), ifFalse: t.last(data) })}
]
  , ParserStart: "program"
}
