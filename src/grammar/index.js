...
var grammar = {
    Lexer: undefined,
    ParserRules: [
    {"name": "func_call", "symbols": ["fully_qualified_name", "func_args"], "postprocess": data => ({ type: "func_call", func: t.first(data), args: t.last(data) })},
    {"name": "func_call", "symbols": ["paren_expr", "func_args"], "postprocess": data => ({ type: "func_call", func: t.first(data), args: t.last(data) })},
    ...
    {"name": "precendence_operation", "symbols": ["zero_precedence"], "postprocess": id},
    {"name": "zero_precedence", "symbols": ["one_precedence", "__nl", plus, "__", "zero_precedence"], "postprocess": t.binaryOp("plus")},
    {"name": "zero_precedence", "symbols": ["one_precedence", "__nl", minus, "__", "zero_precedence"], "postprocess": t.binaryOp("minus")},
    {"name": "zero_precedence", "symbols": ["one_precedence", "__nl", lor, "__", "zero_precedence"], "postprocess": t.binaryOp("lor")},
    {"name": "zero_precedence", "symbols": ["one_precedence"], "postprocess": id},
    {"name": "one_precedence", "symbols": ["two_precedence", "__nl", times, "__", "one_precedence"], "postprocess": t.binaryOp("times")},
    {"name": "one_precedence", "symbols": ["two_precedence", "__nl", div, "__", "one_precedence"], "postprocess": t.binaryOp("div")},
    {"name": "one_precedence", "symbols": ["two_precedence", "__nl", mod, "__", "one_precedence"], "postprocess": t.binaryOp("mod")},
    {"name": "one_precedence", "symbols": ["two_precedence", "__nl", land, "__", "one_precedence"], "postprocess": t.binaryOp("land")},
    {"name": "one_precedence", "symbols": ["two_precedence"], "postprocess": id},
    {"name": "two_precedence", "symbols": ["three_precedence", "__nl", pow, "__", "two_precedence"], "postprocess": t.binaryOp("pow")},
    {"name": "two_precedence", "symbols": ["simple_value", "__nl", kWin, "__", "simple_value"], "postprocess": t.binaryOp("in")},
    {"name": "two_precedence", "symbols": ["simple_value", "__nl", eq, "__", "simple_value"], "postprocess": t.binaryOp("eq")},
    {"name": "two_precedence", "symbols": ["simple_value", "__nl", neq, "__", "simple_value"], "postprocess": t.binaryOp("neq")},
    {"name": "two_precedence", "symbols": ["simple_value", "__nl", lt, "__", "simple_value"], "postprocess": t.binaryOp("lt")},
    {"name": "two_precedence", "symbols": ["simple_value", "__nl", gt, "__", "simple_value"], "postprocess": t.binaryOp("gt")},
    {"name": "two_precedence", "symbols": ["simple_value", "__nl", leq, "__", "simple_value"], "postprocess": t.binaryOp("leq")},
    {"name": "two_precedence", "symbols": ["simple_value", "__nl", geq, "__", "simple_value"], "postprocess": t.binaryOp("geq")},
    {"name": "two_precedence", "symbols": ["three_precedence"], "postprocess": id},
    {"name": "three_precedence", "symbols": ["four_precedence", "__nl", bitwise_and, "__", "three_precedence"], "postprocess": t.binaryOp("bitwise_and")},
    {"name": "three_precedence", "symbols": ["four_precedence", "__nl", bitwise_or, "__", "three_precedence"], "postprocess": t.binaryOp("bitwise_or")},
    {"name": "three_precedence", "symbols": ["four_precedence", "__nl", bitwise_xor, "__", "three_precedence"], "postprocess": t.binaryOp("bitwise_xor")},
    {"name": "three_precedence", "symbols": ["four_precedence"], "postprocess": id},
    {"name": "four_precedence", "symbols": [incr, "fully_qualified_name"], "postprocess": t.unaryOp("pre_increment")},
    {"name": "four_precedence", "symbols": [decr, "fully_qualified_name"], "postprocess": t.unaryOp("pre_decrement")},
    {"name": "four_precedence", "symbols": ["fully_qualified_name", incr], "postprocess": t.unaryOpPost("post_increment")},
    {"name": "four_precedence", "symbols": ["fully_qualified_name", decr], "postprocess": t.unaryOpPost("post_decrement")},
    {"name": "four_precedence", "symbols": [minus, "atomic_value"], "postprocess": t.unaryOp("unary_minus")},
    {"name": "four_precedence", "symbols": [plus, "atomic_value"], "postprocess": t.unaryOp("unary_plus")},
    {"name": "four_precedence", "symbols": [neg, "simple_value"], "postprocess": t.unaryOp("neg")},
    {"name": "four_precedence", "symbols": [bitwise_neg, "simple_value"], "postprocess": t.unaryOp("bitwise_neg")},
    {"name": "four_precedence", "symbols": ["simple_value"], "postprocess": data => ({ type: "sv_unary_expr", data: id(data) })},
